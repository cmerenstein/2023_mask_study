...
pdf("../figures/unweighted_distance_to_first_throat.pdf", width = 5, height = 5)
...
### ----------------- PCOA -------------------------------
set.seed(19002)
unifrac_throat = unweighted[grepl("MASK.+throat", rownames(unweighted)),
                               grepl("MASK.+throat", colnames(unweighted))]
...
pdf("../figures/unweighted_throat_pcoa_by_days.pdf", width = 5, height = 4.5)
