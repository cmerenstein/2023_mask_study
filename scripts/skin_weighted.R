...
pdf("../figures/weighted_distance_to_first_skin.pdf", height = 5, width = 5)
...
### ----------------- PCOA ----------------------------
set.seed(19143)
unifrac_skin = rare_weighted[grepl("MASK.+SKIN", rownames(rare_weighted)),
                               grepl("MASK.+SKIN", colnames(rare_weighted))]
...
## by number of days 
pdf("../figures/weighted_skin_pcoa_by_days.pdf", height = 4.5, width = 5)
